            ...
            <div style={{ display: 'flex'}}>
                ...
                <div style={{ flex: '65%' }}>
                    <button className="rounded-2xl flex items-center bg-light-blue p-2">
                        ...
                        <Link href="/reload">
                            <div style={{ fontSize: '13px' }} className="relative capitalize font-semibold mr-1">Reload Card</div>
                        </Link>
                    </button>
                </div>
                ...
                <div style={{ flex: '35%' }}>
                    <button className="rounded-2xl flex items-center bg-light-blue p-2 ml-auto">
                        <Link href="/">
                            <div style={{ fontSize: '13px' }} className="relative capitalize font-semibold mr-1">Travel history</div>
                        </Link> 
